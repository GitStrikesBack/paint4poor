...
public class Paint4Poor2022 extends Application {
  ...
  public void start(Stage primaryStage) { 
    root = new Pane();
    Scene scene = new Scene(root, 715, 508);
    // Anfang Komponenten
    ...
    label1.setText("Pipetten-Farbe:");
    root.getChildren().add(label1);
    
    checkBox2.setLayoutX(500);
    checkBox2.setLayoutY(160);
    checkBox2.setPrefHeight(17);
    checkBox2.setPrefWidth(100);
    checkBox2.setText("Pipette");
  ...
  public void leinwand_Action(Event evt, int zeilen, int spalten) {
    ...
    if (checkBox1.isSelected()) {
      ...
      String pipettenStyle =  grundStyle + "-fx-background-color: #" + leinwand[x][y].getFarbe().toString().substring(2) + ";";
      label1.setText("Pipetten-Farbe: " + leinwand[x][y].getFarbe().toString().substring(2));
      leinwand[x][y].setStyle(pipettenStyle);
